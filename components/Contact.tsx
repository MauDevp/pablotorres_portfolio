    ...
    <section id="contact" className="py-16 md:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 lg:grid-cols-2">
          ...
          >
            <div className="space-y-2">
              <h3 className="text-2xl font-bold">{translations.contact.info.title[language]}</h3>
              <p className="text-muted-foreground">{translations.contact.info.description[language]}</p>
            </div>
            ...
            <div className="space-y-4 mt-4">
              ...
              >
                ...
                <span className="break-all">{translations.contact.info.email[language]}</span>
              </motion.a>
