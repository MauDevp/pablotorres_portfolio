        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a target="_blank" href="https://www.linkedin.com/in/pabloseb10/" className="text-muted-foreground hover:text-primary transition-colors">
                <svg
              ...
              <a target="_blank" href="https://www.instagram.com/pabloseb10?igsh=ZXI0MHgxbjVzN2c1&utm_source=qr" className="text-muted-foreground hover:text-primary transition-colors">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
