export interface Project {
  ...
  materialsLink?: string; // Enlace para el botón "ver materiales"
  projectLink?: string; // Enlace para el botón "ver proyecto"
  summary: {
...
export const projects: Project[] = [
  // Proyecto 1 - Hiking Urban
  {
    ...
    materialsLink:
      "https://drive.google.com/drive/folders/example-hiking-urban-materials",
    projectLink: "https://urbanvibes.com/hiking-adventures",
    summary: {
  ...
  // Proyecto 2 - TE CAMBIO UN DOMINGO DE RESACA POR ESTO
  {
    ...
    materialsLink:
      "https://drive.google.com/drive/folders/example-te-cambio-domingo-materials",
    projectLink: "https://urbanvibes.com/te-cambio-domingo",
    summary: {
  ...
  // Proyecto 3 - SEMANA DE LA HISPANIDAD
  {
    ...
    materialsLink:
      "https://drive.google.com/drive/folders/example-semana-hispanidad-materials",
    projectLink: "https://urbanvibes.com/semana-hispanidad",
    summary: {
  ...
  // Proyecto 4 - ULISES EN YOUTUBE
  {
    ...
    materialsLink:
      "https://drive.google.com/drive/folders/example-ulises-youtube-materials",
    projectLink: "https://youtube.com/ulises-channel",
    summary: {
  ...
  // Proyecto 5 - Boiler Room con Ulises
  {
    ...
    materialsLink:
      "https://drive.google.com/drive/folders/example-boiler-room-materials",
    projectLink: "https://youtube.com/ulises-boiler-room",
    summary: {
  ...
  // Proyecto 6 - Impulso de Marca Personal para Ulises
  {
    ...
    materialsLink:
      "https://drive.google.com/drive/folders/example-marca-personal-materials",
    projectLink: "https://ulisesalanis.com/portfolio",
    summary: {
  ...
  // Proyecto 7 - Estrategia de Plan de Medios para Marca de Cerveza en Madrid
  {
    ...
    materialsLink:
      "https://drive.google.com/drive/folders/example-cerveza-madrid-materials",
    projectLink: "https://cerveza-artesanal-madrid.com/campaign",
    summary: {
